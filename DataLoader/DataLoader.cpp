...
namespace NeuralNetwork {
    ...
    DataLoader::DataLoader(const std::string &image_path, const std::string &label_path, size_t size_of_batch)
        ...
        image_stream.read(reinterpret_cast<char *>(&magic_number_image), MNIST::POINTER_SIZE);
        ...
        label_stream.read(reinterpret_cast<char *>(&magic_number_label), MNIST::POINTER_SIZE);
